...
try {
  ...
  // Test 3: Export .knolstory & Re-import Verification
  {
    ...
    // Verify project is loaded into storage with all 1692 cuts
    ...
    assert.equal(importedProject.draft.project.lines.length, 1692, 'All 1692 cuts imported');
    ...
    console.log('[E2E Import] .knolstory import successfully loaded 1692 cuts with backgrounds');
